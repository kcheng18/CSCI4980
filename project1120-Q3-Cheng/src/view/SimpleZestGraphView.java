...
public class SimpleZestGraphView {
   public static final String SIMPLEZESTVIEW = "project1120-q3-cheng.partdescriptor.chengzestview";
   public static final String POPUPMENU_ID = "project1120-q3-cheng.popupmenu.mypopupmenu";
