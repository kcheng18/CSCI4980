...
public class ViewPartDescriptor {
	...
	public static final String VIEW_ID = "project0830-part-descriptor-cheng.partdescriptor.viewpartdescriptor";
	// Use Popup Menu's ID in fragment.e4xmi.
	public final static String POPUPMENU_ID = "project0830-part-descriptor-cheng.popupmenu.showhello";
	// Text box object.
