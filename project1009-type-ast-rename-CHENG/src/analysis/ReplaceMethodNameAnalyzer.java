...
public class ReplaceMethodNameAnalyzer extends ProjectAnalyzer {
      ...
      for (ICompilationUnit iCUnit : iCompilationUnits) {
         ...
         cUnit.accept(new ASTVisitor() {
            ...
            public boolean visit(MethodDeclaration node) {
            	...
            	List<?> nParms = node.parameters();
            	/*boolean flag = false;
            	if(mName.equals(newMethodName)) {
            		flag = true;
            	}*/
               // TODO - Class Exercise - complete this visitor.
            	if(equalParams(nParms,curProgElem.getParameters()) && mName.equals(newMethodName))
            		matchedExistingMethod = true;
            	
            	return matchedExistingMethod;
            }
         });
      }
   ...
   boolean equalParams(List<?> parmsLeft, List<?> parmsRight) {
      ...
      for (int i = 0; i < parmsLeft.size(); i++) {
         ...
         if (type1 == null || type2 == null || type1.toString().equals(type2.toString()) == false || obj1 == obj2) {
            return false;
         }
