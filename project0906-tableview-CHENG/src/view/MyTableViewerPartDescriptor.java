...
public class MyTableViewerPartDescriptor {
	...
	/*
	 * private static final Image CHECKED = getImage("checked.gif"); private static
	 * final Image UNCHECKED = getImage("unchecked.gif");
	 */
	...
	private static Image getImage(String file) {
		Bundle bundle = FrameworkUtil.getBundle(MyTableViewerPartDescriptor.class);
