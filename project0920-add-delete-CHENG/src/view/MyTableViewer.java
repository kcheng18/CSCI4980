...
public class MyTableViewer {
	public final static String ID = "project0920-add-delete-cheng.partdescriptor.simpletableinsertdeletecheng";
	public final static String POPUPMENU = "project0920-add-delete-cheng.popupmenu.mypopupmenu";
